        ...
        <DialogContent className="sm:max-w-[500px]">
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-[var(--radix-dropdown-menu-trigger-width)] min-w-[var(--radix-dropdown-menu-trigger-width)]">
                  ...
                  <DropdownMenuItem onClick={() => form.setValue("user_id", null)}>
                    {t("endpoints:everyone")}
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="outline" className="justify-between" type="button">
                    <span>
                      {selectedNamespaceName || t("endpoints:selectNamespace")}
                    </span>
            ...
            <div className="space-y-4 border-t pt-4">
              <h4 className="text-sm font-medium">{t("endpoints:apiKeyAuth")}</h4>
            ...
            <div className="space-y-4 border-t pt-4">
              <h4 className="text-sm font-medium">{t("endpoints:oauthAuth")}</h4>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => form.setValue("enableOauth", checked)}
                  disabled={isSubmitting}
                />
              </div>
            ...
            <div className="flex justify-end space-x-2">
              ...
              <Button type="submit" disabled={isSubmitting || !selectedNamespaceUuid}>
                {isSubmitting ? t("endpoints:creating") : t("endpoints:createEndpoint")}
              </Button>
            </div>
          </form>
        </DialogContent>
